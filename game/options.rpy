...
define config.name = _("WitchWeapon")
define config.log = "wwlog.txt"
...
define gui.about = _p("""
A project to replicate the story of Witch Weapon, a dead gacha game.
""")
...
define config.save_directory = "WitchWeapon-1757548878"
